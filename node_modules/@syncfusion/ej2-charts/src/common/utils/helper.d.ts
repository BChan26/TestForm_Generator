...
/** @private */
export declare function textElement(renderer: SvgRenderer | CanvasRenderer, option: TextOption, font: FontModel, color: string, parent: HTMLElement | Element, isMinus?: boolean, redraw?: boolean, isAnimate?: boolean, forceAnimate?: boolean, animateDuration?: number, seriesClipRect?: Rect, labelSize?: Size, isRotatedLabelIntersect?: boolean, isCanvas?: boolean): Element;
/**
 ...
 */
export declare function textWrap(currentLabel: string, maximumWidth: number, font: FontModel, wrapAnyWhere?: boolean, clip?: boolean): string[];
/**
 * Method to find new text and element size based on textWrap
 */
export declare function textWrapAnyWhere(currentLabel: string, maximumWidth: number, font: FontModel): string[];
/**
