...
var WordExport = /** @class */ (function () {
    ...
    WordExport.prototype.serializeThemes = function () {
        if (!isNullOrUndefined(this.mThemes)) {
            ...
            for (var i = 0; i < this.mThemes.fontScheme.majorFontScheme.fontSchemeList.length; i++) {
                var theme = this.mThemes.fontScheme.majorFontScheme.fontSchemeList[parseInt(i.toString(), 10)];
                this.themeFont(writer, theme);
            }
            var keys = Object.keys(this.mThemes.fontScheme.majorFontScheme.fontTypeface);
            ...
            for (var i = 0; i < this.mThemes.fontScheme.minorFontScheme.fontSchemeList.length; i++) {
                var theme = this.mThemes.fontScheme.minorFontScheme.fontSchemeList[parseInt(i.toString(), 10)];
                this.themeFont(writer, theme);
            }
        ...
        if (sectionFormat.numberOfColumns !== undefined && sectionFormat.numberOfColumns > 1) {
            ...
            if (sectionFormat.equalWidth) {
                ...
                if (sectionFormat.columns !== undefined && sectionFormat.columns.length > 0) {
                    for (var i = 0; i < sectionFormat.columns.length; i++) {
    ...
    WordExport.prototype.serializeCharacterFormat = function (writer, characterFormat) {
        ...
        if (!isNullOrUndefined(characterFormat.fontFamily)) {
            ...
            if (!isNullOrUndefined(characterFormat.fontFamilyAscii)) {
                var key = HelperMethods.isThemeFont(characterFormat.fontFamilyAscii) ? 'asciiTheme' : 'ascii';
            ...
            if (!isNullOrUndefined(characterFormat.fontFamilyFarEast)) {
                var key = HelperMethods.isThemeFont(characterFormat.fontFamilyFarEast) ? 'eastAsiaTheme' : 'eastAsia';
            ...
            if (!isNullOrUndefined(characterFormat.fontFamilyNonFarEast)) {
                var key = HelperMethods.isThemeFont(characterFormat.fontFamilyNonFarEast) ? 'hAnsiTheme' : 'hAnsi';
            ...
            if (!isNullOrUndefined(characterFormat.fontFamilyBidi)) {
                var key = HelperMethods.isThemeFont(characterFormat.fontFamilyBidi) ? 'cstheme' : 'cs';
    ...
    WordExport.prototype.serializeThemeFontLang = function (writer) {
        var isLanguageIdBi = this.themeFontLang.localeIdBidi > 0;
        var isLanguageId = this.themeFontLang.localeIdAscii > 0;
        var isLanguageIdFarEast = this.themeFontLang.localeIdFarEast > 0;
        if (isLanguageId || isLanguageIdFarEast || isLanguageIdBi) {
            writer.writeStartElement('w', 'themeFontLang', undefined);
            if (isLanguageId) {
                var ascii = LocaleId[this.themeFontLang.localeIdAscii];
                writer.writeAttributeString('w', 'val', undefined, ascii.replace('_', '-')); //Ascii key
            }
            if (isLanguageIdBi) {
                var bidi = LocaleId[this.themeFontLang.localeIdBidi];
                writer.writeAttributeString('w', 'bidi', undefined, bidi.replace('_', '-')); //Bidi key
            }
            if (isLanguageIdFarEast) {
                var farEast = LocaleId[this.themeFontLang.localeIdFarEast];
