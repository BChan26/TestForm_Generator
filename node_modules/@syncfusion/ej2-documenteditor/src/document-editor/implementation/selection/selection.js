...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype.moveUp = function () {
        ...
        this.upDownSelectionLength = this.start.location.x;
        var beforeUp = this.start.currentWidget.paragraph.bodyWidget.indexInOwner;
        this.start.moveUp(this, this.upDownSelectionLength);
        var afterUp = this.start.currentWidget.paragraph.bodyWidget.indexInOwner;
    ...
    Selection.prototype.moveDown = function () {
        ...
        this.upDownSelectionLength = this.start.location.x;
        var beforeDown = this.start.currentWidget.paragraph.bodyWidget.indexInOwner;
        this.start.moveDown(this, this.upDownSelectionLength);
        var afterDown = this.start.currentWidget.paragraph.bodyWidget.indexInOwner;
    ...
    */
    ...
    Selection.prototype.getLineWidgetParaWidget = function (widget, point) {
        ...
        if (widget.bodyWidget.page.bodyWidgets.length > 1 && widget.bodyWidget.sectionFormat.columns.length > 1) {
            ...
            for (var k = 0; k < widget.childWidgets.length; k++) {
                lastLine = widget.childWidgets[k];
            }
            var nextBlock = lastLine.paragraph.nextRenderedWidget;
            if (lastLine.isLastLine() && isNullOrUndefined(nextBlock) && (widget.y < point.y)) {
                var previousBodyWidget = widget.bodyWidget.previousRenderedWidget;
                if (!isNullOrUndefined(previousBodyWidget)) {
                    for (var i = 0; i < previousBodyWidget.childWidgets.length; i++) {
                        previousParagraph = previousBodyWidget.childWidgets[i];
                        if (previousParagraph.y <= point.y && previousParagraph.y > widget.y) {
                            for (var j = 0; j < previousParagraph.childWidgets.length; j++) {
                                var previousLine = previousParagraph.childWidgets[j];
    ...
    */
    ...
    Selection.prototype.navigateToNextEditingRegion = function () {
        ...
        if (this.editRangeCollection.length > 0) {
            ...
            var length_1 = this.editRangeCollection.length;
            var index = length_1;
            if (!isNullOrUndefined(editRange)) {
                index = this.editRangeCollection.indexOf(editRange);
            }
            var editRangeStart = index < length_1 - 1 ?
